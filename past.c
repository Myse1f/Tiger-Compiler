...
#include "past.h" /* function prototype */

/* local function prototypes */
static void pr_var(FILE *out, var_t v, int d);
static void pr_dec(FILE *out, dec_t v, int d);
static void pr_ty(FILE *out, ty_t v, int d);
static void pr_field(FILE *out, field_t v, int d);
static void pr_fieldList(FILE *out, fieldList_t v, int d);
static void pr_expList(FILE *out, expList_t v, int d);
static void pr_fundec(FILE *out, fundec_t v, int d);
static void pr_fundecList(FILE *out, fundecList_t v, int d);
static void pr_decList(FILE *out, decList_t v, int d);
static void pr_namety(FILE *out, namety_t v, int d);
static void pr_nametyList(FILE *out, nametyList_t v, int d);
static void pr_efield(FILE *out, efield_t v, int d);
static void pr_efieldList(FILE *out, efieldList_t v, int d);
...
/* Print var_t types. Indent d spaces. */
static void pr_var(FILE *out, var_t v, int d) {
 indent(out, d);
 switch (v->kind) {
 case A_simpleVar:
...
/* Print var_t types. Indent d spaces. */
void pr_exp(FILE *out, exp_t v, int d) {
 indent(out, d);
 switch (v->kind) {
 case A_varExp:
